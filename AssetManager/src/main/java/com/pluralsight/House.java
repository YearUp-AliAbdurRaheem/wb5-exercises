...
public class House extends Asset {
    ...
    public double getValue() {
        double pricePerSqFt;
        switch(condition) {
            case 1: pricePerSqFt = 180.00; break;
            case 2: pricePerSqFt = 130.00; break;
            case 3: pricePerSqFt = 90.00; break;
            case 4: pricePerSqFt = 80.00; break;
            default: pricePerSqFt = 0.00; // Dosent need break
        }
        
        return (pricePerSqFt * squareFoot) + (0.25 * lotSize); // Math to get the value of the house
    }
}
